...
#include "abb_irb120_commander/PoseRPYarray.h"
...
class MoveEnable{
  public:
    void cmdCallback(const abb_irb120_commander::PoseRPYarray::ConstPtr& msg);
};
...
// moveit_visual_tools::MoveItVisualToolsPtr visual_tools_;
  ...
  void MoveEnable::cmdCallback(const abb_irb120_commander::PoseRPYarray::ConstPtr& msg){
