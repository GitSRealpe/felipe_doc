...
#include "abb_irb120_commander/PoseRPY.h"
#include <sstream>
#include "iostream"
...
class MoveEnable{
  public:
    void cmdCallback(const abb_irb120_commander::PoseRPY::ConstPtr& msg);
};
...
// moveit_visual_tools::MoveItVisualToolsPtr visual_tools_;
  ...
  void MoveEnable::cmdCallback(const abb_irb120_commander::PoseRPY::ConstPtr& msg){
    ...
    // move_group.setPoseReferenceFrame("base_iiwa"); /////aber psss
...
int main(int argc, char** argv)
{
  ...
  // visual_tools_.reset(new moveit_visual_tools::MoveItVisualTools("base_iiwa","/moveit_visual_markers"));
